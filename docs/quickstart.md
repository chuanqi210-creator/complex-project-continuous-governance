...
- Assess threads, subagents, review lanes, and automations as resources that may mature over the first few beats; do not block Goal/Plan/Loop because those resources are not ready yet. If a durable lane is needed but cannot yet be created as a visible thread or automation, keep a manager-owned lane record and continue.
