# Evidence Example: Evidence Fill

## Claim Boundary

- claim_to_support: The final summary may say which fixed metrics are source-backed.
- cannot_claim: The evidence table proves real-world impact, causality, or long-term outcomes.
...
- divergence_noop_reason: Model, formula, and metric table are already fixed.
- model_discovery_skipped: yes
- skipped_because: Adding candidate frameworks would increase friction without changing the task.
