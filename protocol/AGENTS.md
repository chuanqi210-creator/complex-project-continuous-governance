...
- Show new users the `user_visible_trigger_guide` in ordinary language so they know "连续节拍", "多线程/子代理", "外部工具/账号/API", "完整扫描 Complex", and "只要人看版" are available steering words.
